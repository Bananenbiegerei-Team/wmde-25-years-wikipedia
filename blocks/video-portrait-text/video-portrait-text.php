...
<section id="<?php echo esc_attr($id); ?>" class="relative w-full <?php echo esc_attr($className); ?>">
    <div class="grid grid-cols-4 gap-8 mx-auto md:grid-cols-8">

        <div class="relative grid w-full h-full col-span-4 md:col-span-3">
        ...
        <div class="flex flex-col justify-center col-span-4 space-y-2 md:col-span-5">
            <div>
