<?php
/**
 * W25 Participate CTA Block Template
 *
...
$id = 'w25-participate-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'w25-participate';
...
$cta_text = get_field('cta_text') ?: 'Schreiben Sie mit am Wissen der Welt.';
