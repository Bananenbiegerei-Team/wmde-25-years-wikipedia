<div class="flex flex-col">
    <h3 for="newsletter-signup-form" class="mb-2 text-base text-blue-dark font-menus"><?php _e('Newlsetter Anmeldung', BB_TEXT_DOMAIN); ?></h3>
...
<div x-data="{ open: false }" class="">
    ...
    <span x-on:click="open = true">
        <button type="button" class="-mx-2 btn btn-link btn-xs font-menus text-blue-dark">
